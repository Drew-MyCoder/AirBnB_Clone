...
class HBNBCommand(cmd.Cmd):
    ...
    def obj_count(arg):
        ...
        """
        Usage: <class name>.count(), retrieves the number of instances
        of a class
        """
        if not arg:
            print("** class name missing **")
    ...
    def do_quit(self, arg):
        ...
        """
        this method is called when 'quit' is passed by the user; provides a way of
        exiting the command line interpreter (via Ctrl+d)
        """
        # Returns True to stop the command loop
        return True

    def do_EOF(self, arg):
        """EOF implementation to exit the program (via Ctrl+d)\n"""
        """
        method is called when Ctrl+d is typed in; this provides the standard way of
    ...
    def emptyline(self):
        ...
        last command is repeated;this behavior can be changed by overriding
