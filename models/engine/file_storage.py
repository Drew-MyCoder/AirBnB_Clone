#!/usr/bin/python3
"""
0x00. AirBnB clone project - The console
...
class FileStorage:
    ...
    This class is named FileStorage
    """
    ...
    def new(self, obj):
        """
        function which is used to set in __objects the obj with key <obj class name>.id.
        """
    ...
    def save(self):
        """
        function that serializes __objects to the JSON(JavaScript object notation) file
